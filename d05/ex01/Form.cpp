...
Form const & Form::operator=(Form const & rhs)
{
    if (this != &rhs)
    {
        *this = Form(rhs._name, rhs._gradeRequiredToSign, rhs._gradeRequiredToExecute);
...
std::ostream & operator<<(std::ostream & o, Form const & rhs)
{
    ...
    o << "Grade required to sign form: " << rhs.getGradeRequiredToSign() << std::endl;
    o << "Grade required to execute form: " << rhs.getGradeRequiredtoExecute() << std::endl;
    o << "Sign status: " << rhs.isSigned();
    return (o);
}
